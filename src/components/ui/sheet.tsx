...
const sheetVariants = cva(
  'bg-page data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 gap-4 p-6 text-gray-900 shadow-md transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
